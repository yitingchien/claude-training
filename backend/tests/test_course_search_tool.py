...
class TestCourseSearchTool:
    ...
    def test_execute_with_query_only_success(self, mock_vector_store, search_results_with_data):
    ...
    def test_execute_with_course_name_filter(self, mock_vector_store, search_results_with_data):
    ...
    def test_execute_with_lesson_number_filter(self, mock_vector_store, search_results_with_data):
    ...
    def test_execute_with_all_filters(self, mock_vector_store, search_results_with_data):
    ...
    def test_execute_with_search_error(self, mock_vector_store, search_results_with_error):
    ...
    def test_source_tracking_and_links(self, mock_vector_store, search_results_with_data):
    ...
    def test_multiple_queries_reset_sources(self, mock_vector_store, search_results_with_data):
